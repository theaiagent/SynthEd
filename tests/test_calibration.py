...
class TestCalibrationMap:
    ...
    def test_estimate_known_point(self):
        ...
        # 1-sem, rate=0.50, observed=0.379
        result = self.cal.estimate(0.379, n_semesters=1)
        assert abs(result.estimated_dropout_base_rate - 0.50) < 0.05
    ...
    def test_estimate_interpolation(self):
        ...
        # 0.340 -> 0.40, 0.379 -> 0.50, so 0.35 should give ~0.40-0.55
