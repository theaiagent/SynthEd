...
class DataExporter:
    ...
    def export_students(self, students: list[StudentPersona]) -> str:
        ...
        fieldnames = [
            ...
            "learner_autonomy",
            "academic_reading_writing", "internet_reliability", "disability_severity",
            "device_type",
        ...
        with open(filepath, "w", newline="", encoding="utf-8") as f:
            ...
            for s in students:
                row = {
                    ...
                    "internet_reliability": round(s.internet_reliability, 3),
                    "disability_severity": s.disability_severity,
                    "device_type": s.device_type,
                    "preferred_learning_style": s.preferred_learning_style,
                    "employment_intensity": round(s.employment_intensity, 3),
                    "family_responsibility_level": round(s.family_responsibility_level, 3),
