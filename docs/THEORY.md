...
├── tests/                       # 884 pytest tests across 49 files
├── docs/
│   ├── GUIDE.md                 # User guide
│   └── THEORY.md                # This file
...
884 pytest tests across 49 files:
...
| `test_pipeline_integration.py` | 26 | SynthEdPipeline |
...
| `test_sobol.py` | 44 | Sobol sensitivity analysis |
